...
graph TD
    ...
    %% ==========================================
    AI_Comm["<div style='text-align: left;'>🤖 AI 輔助 系統連線建置 :<br>1. PySerial 序列埠連線<br>2. 封裝標頭與大端序結構體</div>"]:::ai
    ...
    %% ==========================================
    AI1["<div style='text-align: left;'>🤖 AI 輔助 生成異常測資 :<br>1. 寫入越界 LBA<br>2. 注入錯誤 Checksum<br>3. 注入無效 Opcode</div>"]:::ai --> Step2

    AI2["<div style='text-align: left;'>🤖 AI 輔助 破壞系統 :<br>1. 模擬中斷過載觸發 ORE<br>2. 高頻寫入相同 LBA<br>3. 耗盡 PBA 執行 GC 資料回收</div>"]:::ai --> Step3
    
    %% 結束
    Step3 --> End([B. 產出統計報告 Pass / Fail ]):::output

    AI["<div style='text-align: left;'>🤖 AI 輔助 視覺化 Log :<br>1. 自動配置 ANSI 顏色代碼<br>2. 即時統計 PASS / FAIL 燈號</div>"]:::ai --> End
